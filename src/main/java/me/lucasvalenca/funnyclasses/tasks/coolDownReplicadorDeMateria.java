...
public class coolDownReplicadorDeMateria extends BukkitRunnable {
    FunnyClasses plugin;
    Arquiteto arquiteto;

    public coolDownReplicadorDeMateria(FunnyClasses plugin, Arquiteto arquiteto) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.arquiteto.eraseCoolDownReplicadorDeMateria();
    }
}
