...
public class askToRemoveIsLightningStrike extends BukkitRunnable {
    FunnyClasses plugin;
    Errante errante;

    public askToRemoveIsLightningStrike(FunnyClasses plugin, Errante errante) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.errante.takeOffIsLightningStrike();
    }
}
