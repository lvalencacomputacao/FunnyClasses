...
public class coolDownSuperPonte extends BukkitRunnable {
    FunnyClasses plugin;
    Arquiteto arquiteto;

    public coolDownSuperPonte(FunnyClasses plugin, Arquiteto arquiteto) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.arquiteto.eraseCoolDownSuperPonte();
    }
}
