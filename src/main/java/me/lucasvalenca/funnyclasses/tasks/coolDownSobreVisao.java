...
public class coolDownSobreVisao extends BukkitRunnable {
    FunnyClasses plugin;
    Protetor protetor;

    public coolDownSobreVisao(FunnyClasses plugin, Protetor protetor) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.protetor.eraseCoolDownSobreVisao();
    }
}
