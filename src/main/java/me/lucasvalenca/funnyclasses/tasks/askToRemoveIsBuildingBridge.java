...
public class askToRemoveIsBuildingBridge extends BukkitRunnable {
    FunnyClasses plugin;
    Arquiteto arquiteto;

    public askToRemoveIsBuildingBridge(FunnyClasses plugin, Arquiteto arquiteto) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.arquiteto.setOffIsBuildingBridge();
    }
}
