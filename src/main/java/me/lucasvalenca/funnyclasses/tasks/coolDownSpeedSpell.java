...
public class coolDownSpeedSpell extends BukkitRunnable {
    FunnyClasses plugin;
    Protetor protetor;

    public coolDownSpeedSpell(FunnyClasses plugin, Protetor protetor) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.protetor.eraseCoolDownSpeedSpell();
    }
}
