...
public class coolDownSuperPulo extends BukkitRunnable {
    FunnyClasses plugin;
    Sonhador sonhador;

    public coolDownSuperPulo(FunnyClasses plugin, Sonhador sonhador) {
        this.plugin = plugin;
    ...
    @Override
    public void run() {
        this.sonhador.eraseCoolDownSuperPulo();
    }
}
